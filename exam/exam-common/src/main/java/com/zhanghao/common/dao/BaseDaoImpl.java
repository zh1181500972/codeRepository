package com.zhanghao.common.dao;
...
import com.zhanghao.common.exceptions.BizException;
...
public abstract class BaseDaoImpl<T extends BaseEntity> extends SqlSessionDaoSupport implements BaseDao<T>{
	...
	public int insertSelective(T record) {
		...
		return sessionTemplate.insert(getStatement(INSERT_SELECTIVE), record);
	}

	@Override
	public int updateByPrimaryKeySelective(T record) {
		// TODO Auto-generated method stub
		return sessionTemplate.update(getStatement(UPDATENOTNULL), record);
	}
